...
filename2='../OscopeData/dataAdjacencyMatrixe02/WaterfallbootstrapSequential_CPUDPSF_TF_2000Boot_data_s45res_C28G8442_edgeNetwork.csv'
...
filename1='../OscopeData/dataAdjacencyMatrixePiDiv9/WaterfallbootstrapSequential_CPUDPSF_TF_2000Boot_data_s123res_C73G9200_edgeNetwork.csv'
filename2='../OscopeData/dataAdjacencyMatrixePiDiv9/WaterfallbootstrapSequential_CPUDPSF_TF_2000Boot_data_s45res_C28G8442_edgeNetwork.csv'
...
filename1='../OscopeData/FirstData/WaterfallbootstrapSequential_CPUDPSF_TF_2000Boot_data_s123res_C73G9200_edgeNetwork.csv'
filename2='../OscopeData/FirstData/WaterfallbootstrapSequential_CPUDPSF_TF_2000Boot_data_s45res_C28G8442_edgeNetwork.csv'
...
venn.plot.df3=draw.pairwise.venn(area1 = length(g1name), area2 = length(g2name), cross.area = ncomm, category = c("(c) quiscent", 
    "(c) active"), lty = rep("blank",2), fill = c("light blue", "pink"), alpha = rep(0.5, 2), cat.pos = c(10,20), cat.dist = rep(0.025, 2), cat.dist=1)
...
tiff(filename = "Global_Venn_diagram.tiff",width=780,height=480,pointsize=20);
