...
genesout='../OscopeData/GenesLabels/MappingWithGOterm/'
...
"mgi_symbol","go_id","description"),values=genes,mart= mart)} else {
	G_list <- getBM(filters= "mgi_symbol", attributes= c("ensembl_gene_id",
"mgi_symbol","go_id","description"),values=genes,mart= mart)}	
gooo=G_list[,3]
